...
console.log(`Generated ${articles.length} articles, ${recommendations.length} recommendations, ${glossary.length} glossary entries, and ${checkInSets.length} check-in sets at src/generated/contentCatalog.ts`)
