...
export function AssistantScreen() {
  ...
  return (
    <Screen>
      ...
      {searched && results.length === 0 && !todayExplanation ? <p className="empty-state icon-label" role="status"><WarningIcon aria-hidden="true" className="icon-leading" focusable="false" />No matching catalog content was found. Try a dosha name, check-ins, routine, or provisional guidance.</p> : null}
